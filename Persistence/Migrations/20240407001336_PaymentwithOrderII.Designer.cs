...
namespace Persistence.Migrations
{
    ...
    [Migration("20240407001336_PaymentwithOrderII")]
    partial class PaymentwithOrderII
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Order", b =>
                {
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasCheckConstraint("StateValidation", "[State] >= 0 and [State] <= 3");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Other.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PayedTransactionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Persistence.Context.ApplicationIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasCheckConstraint("OTPValidation", "len([OTP]) = 6");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Customer", b =>
                {
                    b.HasOne("Persistence.Context.ApplicationIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Other.Payment", b =>
                {
                    b.HasOne("Domain.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("Domain.Entities.Other.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
